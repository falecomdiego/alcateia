# MDN-RPP01-GATE-001-V0.5 — Checklist mestre de gates
...
- [x] Ferramenta identificada, com configuração técnica homologada e exportação sintética de teste validada.
