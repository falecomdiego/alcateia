# MDN-RPP01-GATE-001-V0.2 — Checklist mestre de gates
...
- [x] Período de referência definido: 01/06/2026 a 15/06/2026.
- [x] Pergunta central e subperguntas operacionalizadas no manifesto.
- [ ] Fontes previstas preenchidas: a planilha recebida contém comentaristas, não publicações-fonte.
- [x] Critérios de inclusão e exclusão definidos no manifesto.
- [ ] Ferramenta identificada, mas configuração e exportação sintética ainda pendentes.
- [ ] Papéis parcialmente identificados; funções metodológica, proteção de dados e publicação permanecem pendentes.
- [ ] Retenção definida em 12 meses; lista de acesso, cópia protegida e método de descarte permanecem pendentes.
...
- [ ] Aceite direto da revisora independente registrada pelo responsável.
